...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 23:47:50 2022
...
train_generator = train.flow_from_directory(train_dir, # 이미지가 있는 파일 경로 
...
model.save('LeakDistinguishment.h5') #모델 저장
